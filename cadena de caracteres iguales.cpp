/* 57) Pedir al usuario que digite 2 cadenas de caracteres, e indicar si ambas cadenas
...
int main(){
 ...
 if(strcmp(palabra1,palabra2)==0){//STRCMP retorna cero es verdadero osea son iguales
